...
This per-office `AGENTS.md` is the long standing mandate for ordinary spawned agents and terminal-visible superCC panes. A collaboration address such as `/root/xingbu_wave` is only routing metadata; office identity exists only after profile/dossier/court-skill hashes match and preload ack passes.
...
- preload_ack: first report must include preload_status=PASSED, role_key=xingbu, matching profile_hash/dossier_hash/court_skill_hash, agent_dossier_loaded=YES, and loaded_skills including court-capability-router.
...
- profile_hash: 51d839bff1236c1d2dd5d89929e85c80baf6125b3fc26fda1c97f8669780098d
