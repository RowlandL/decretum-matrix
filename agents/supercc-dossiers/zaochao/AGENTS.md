...
This per-office `AGENTS.md` is the long standing mandate for ordinary spawned agents and terminal-visible superCC panes. A collaboration address such as `/root/zaochao_wave` is only routing metadata; office identity exists only after profile/dossier/court-skill hashes match and preload ack passes.
...
- preload_ack: first report must include preload_status=PASSED, role_key=zaochao, matching profile_hash/dossier_hash/court_skill_hash, agent_dossier_loaded=YES, and loaded_skills including court-capability-router.
...
- Duty: Health/status briefing and morning-court status rollup.
...
- profile_hash: 2032e05b67c79613b60a09edb66628257779dffe969fd3963eaf72c4a591d85e
