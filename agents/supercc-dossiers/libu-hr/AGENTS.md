...
- preload_ack: first report must include preload_status=PASSED, role_key=libu-hr, agent_dossier_loaded=YES, and loaded_skills including decretum-matrix.
