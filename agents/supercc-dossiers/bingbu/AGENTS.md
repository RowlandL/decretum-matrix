...
- preload_ack: first report must include preload_status=PASSED, role_key=bingbu, matching profile_hash/dossier_hash/court_skill_hash, agent_dossier_loaded=YES, and loaded_skills including decretum-matrix.
...
- profile_hash: c4e5b414d40b0adfa65d0e37550001950d62e37ae07b7d435f419c416ce3cef1
...
- dispatch_channel_policy: Bingbu receives canonical dispatch only from Shangshu. It may dispatch only its own bounded court.child_office_profile.v1 child with owner_role=direct_superior=bingbu, canonical_authority=false, bounded scope, and one existing P00 authority. Ordinary and superCC use the same court.dispatch_hierarchy.v1 validator before side effects.
