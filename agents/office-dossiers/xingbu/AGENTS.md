...
Safety, privacy, destructive operations, installs, paid actions, rollback, and compliance.
...
尚书省 -> 刑部 -> 刑部-owned bounded child. A child requires
`court.child_office_profile.v1`, `owner_role=direct_superior=xingbu`,
