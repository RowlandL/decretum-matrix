...
Resources, paths, dependencies, versions, token/session caps, budgets, and inventory freshness.
...
尚书省 -> 户部 -> 户部-owned bounded child. A child requires
`court.child_office_profile.v1`, `owner_role=direct_superior=hubu`,
