...
| `references/sections/court-context-compression-survival.md` | Multi-cycle context compression survival, original decree and plan hash anchors, mandatory post-compaction skill reload, and reply-format drift repair. |
