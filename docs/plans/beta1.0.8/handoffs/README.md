...
| 5 | VERIFY_READY | phase-5-handoff.md / phase-5-evidence.md | 5e0b660 → 3bd2d5a（发布前 review：R-01..R-06 + TDD 第二轮 R-07..R-11，见 review-findings §3） | 待 REVIEWER（含 release-review-beta1.0.8.md 批准记录 + §4.1 review 意见闭环） | 2026-08-31 |
