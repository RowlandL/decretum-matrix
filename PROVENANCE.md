...
| `docs/wiki/Architecture.md` and `docs/architecture/` framework adoption and source snapshots | `upstream-inspired / AI-assisted local documentation` | Framework adopted under the user's 2026-09-05 direction from five local 2026-07-12 design documents. Original Markdown is preserved in `docs/architecture/sources/2026-07-12/`; the source inventory is `docs/architecture/README.md`. Existing semantic-architecture attribution and notices remain applicable. |
