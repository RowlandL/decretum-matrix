...
RETIRED_COMPATIBILITY_ENTRYPOINTS = frozenset(
    {
        ...
        "scripts/services/export_shiguan_obsidian.py",
        "scripts/services/serve_shiguan_tree.py",
        "scripts/services/shiguan_autosync_daemon.py",
        "scripts/services/shiguan_git_federation.py",
        "scripts/services/shiguan_migration_gate.py",
        "scripts/services/shiguan_service_daemon.py",
        "scripts/services/supercc_watchdog.py",
        "scripts/services/sync_shiguan_obsidian_vault.py",
...
COMPATIBILITY_SHELL_ENTRYPOINTS = frozenset(
    {
        "scripts/agent_runtime_probe.py",
        "scripts/agente_terminal.py",
        "scripts/archive_runtime_task.py",
        "scripts/build_release_artifacts.py",
        "scripts/build_shiguan_knowledge_graph.py",
        "scripts/check_active_copy_hashes.py",
        "scripts/check_agente_terminal.py",
        "scripts/check_capability_index_gate.py",
        "scripts/check_catalog.py",
        "scripts/check_cli_cwd_invariance.py",
        "scripts/check_cli_performance.py",
        "scripts/check_closeout_conflict_scan.py",
        "scripts/check_codex_agent_roles.py",
        "scripts/check_context_compression_survival.py",
        "scripts/check_court_agent_config.py",
        "scripts/check_court_agent_lifecycle.py",
        "scripts/check_court_capability_recruitment.py",
        "scripts/check_court_code_session_numbering.py",
        "scripts/check_court_codex_host_resolution.py",
        "scripts/check_court_codex_office_worker.py",
        "scripts/check_court_complexity_budget.py",
        "scripts/check_court_dispatch_hierarchy.py",
        "scripts/check_court_dispatch_policy.py",
        "scripts/check_court_intake_gate.py",
        "scripts/check_court_intervention_matrix.py",
        "scripts/check_court_mcp_server.py",
        "scripts/check_court_model_router.py",
        "scripts/check_court_multi_instance_dispatch.py",
        "scripts/check_court_native_host_dispatch.py",
        "scripts/check_court_office_assignment_binding.py",
        "scripts/check_court_office_bootstrap.py",
        "scripts/check_court_open_fastpath.py",
        "scripts/check_court_outcome_gate.py",
        "scripts/check_court_preload_semantics.py",
        "scripts/check_court_result_semantics.py",
        "scripts/check_court_runtime.py",
        "scripts/check_court_runtime_completion.py",
        "scripts/check_court_runtime_concurrency.py",
        "scripts/check_court_session_closeout.py",
        "scripts/check_court_usage_ledger.py",
        "scripts/check_debug.py",
        "scripts/check_doctor.py",
        "scripts/check_doctor_debug_fix.py",
        "scripts/check_governance_framework.py",
        "scripts/check_iku_repair.py",
        "scripts/check_install_current_agent_copy.py",
        "scripts/check_install_projection_closure.py",
        "scripts/check_install_prompt.py",
        "scripts/check_install_release_boundary.py",
        "scripts/check_memory_pipeline_fixture.py",
        "scripts/check_obsidian_sync_transaction.py",
        "scripts/check_p00_semantic_dispatch_context.py",
        "scripts/check_package_privacy.py",
        "scripts/check_portability.py",
        "scripts/check_read_only_contract.py",
        "scripts/check_release_gate.py",
        "scripts/check_release_legal.py",
        "scripts/check_release_manifest.py",
        "scripts/check_release_metadata.py",
        "scripts/check_response_draft_fixtures.py",
        "scripts/check_response_fewshot_format.py",
        "scripts/check_runtime_identity_contract.py",
        "scripts/check_semantic_continuity.py",
        "scripts/check_shiguan_concurrency.py",
        "scripts/check_shiguan_full_record_index.py",
        "scripts/check_shiguan_git_federation.py",
        "scripts/check_shiguan_host_memory_and_child_trace.py",
        "scripts/check_shiguan_http.py",
        "scripts/check_shiguan_import_queue.py",
        "scripts/check_shiguan_lineage_rebuild_compatibility.py",
        "scripts/check_shiguan_lineage_taxonomy.py",
        "scripts/check_shiguan_migration_gate.py",
        "scripts/check_shiguan_peer_state_transaction.py",
        "scripts/check_shiguan_pending_quarantine_plan.py",
        "scripts/check_shiguan_queue_and_autosync_safety.py",
        "scripts/check_shiguan_recall_precision.py",
        "scripts/check_skill_identity.py",
        "scripts/check_source_budget_refactor.py",
        "scripts/check_source_state_budget.py",
        "scripts/check_stage3_recovery_chain.py",
        "scripts/check_startup_fastpath_contract.py",
        "scripts/check_supercc_claude_hard_gates.py",
        "scripts/check_supercc_client_selection.py",
        "scripts/check_supercc_functional.py",
        "scripts/check_supercc_ministry_dispatch.py",
        "scripts/check_supercc_no_silence_429_patrol.py",
        "scripts/check_supercc_profiles.py",
        "scripts/check_supercc_squad_wrapper.py",
        "scripts/check_supercc_state_concurrency.py",
        "scripts/check_supercc_super_entry.py",
        "scripts/check_supercc_truth_gates.py",
        "scripts/closeout_conflict_scan.py",
        "scripts/court_codex_host_resolution.py",
        "scripts/court_codex_office_worker.py",
        "scripts/court_codex_protocol_launcher.py",
        "scripts/court_heartbeat_watch.py",
        "scripts/court_open_fastpath.py",
        "scripts/court_session_numbering.py",
        "scripts/court_usage_ledger.py",
        "scripts/ensure_codex_yolo_startup_task.py",
        "scripts/ensure_court_agent_config.py",
        "scripts/ensure_hermes_supercc.py",
        ...
        "scripts/report_office_startup_latency.py",
        "scripts/serve_shiguan_tree.py",
        "scripts/shiguan_autosync_daemon.py",
        "scripts/shiguan_git_federation.py",
        "scripts/shiguan_migration_gate.py",
        "scripts/shiguan_pending_governance.py",
        "scripts/shiguan_pending_governance_cli.py",
        "scripts/shiguan_service_daemon.py",
        "scripts/stress_supercc_rate_limit.py",
