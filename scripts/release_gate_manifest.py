...
REQUIRED_STEP_CONTRACTS: tuple[tuple[str, str, tuple[str, ...], str], ...] = (
    ...
    ("court_plan_artifacts", "source", ("$PYTHON", "scripts/checks/check_court_plan_artifacts.py"), "always"),
    ...
    ("court_complexity_budget", "source", ("$PYTHON", "scripts/checks/check_court_complexity_budget.py"), "always"),
    (
