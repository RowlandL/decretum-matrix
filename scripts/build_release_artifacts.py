...
def run_self_tests(root: Path = ROOT) -> dict[str, bool]:
    tests: dict[str, bool] = {
        ...
        "canonical_beta_1_0_2_artifact_required": (
            release_payload_manifest.RELEASE_LABEL == "beta1.0.2"
            and release_payload_manifest.ARTIFACT_NAME
            == "decretum-matrix-beta1.0.2.zip"
        ),
        "major_release_label_supported": RELEASE_RE.fullmatch("beta1.0.2") is not None,
