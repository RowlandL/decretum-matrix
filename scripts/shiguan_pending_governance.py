...
Registered in check_unified_cli.COMPATIBILITY_SHELL_ENTRYPOINTS so it is not discovered twice; direct ``python scripts/shiguan_pending_governance.py`` calls keep working.
"""
