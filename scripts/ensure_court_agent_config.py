...
Registered in check_unified_cli.COMPATIBILITY_SHELL_ENTRYPOINTS so it is not discovered twice; direct ``python scripts/ensure_court_agent_config.py`` calls keep working.
"""
